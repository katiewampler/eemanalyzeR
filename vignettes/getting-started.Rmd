...
-   **\* .png:** Plots of the individual EEMs
    ...
    ![](eemanalyzeR-example/B1S2ExampleTeaStdSEM.png){width="500"}

-   **absorbance_plot_filename.png:** Plot showing the absorbance
    spectra

    ![](eemanalyzeR-example/absorbance_plot_eemanalyzeR-example.png){width="500"}

-   **summary_plots_filename.png:** Plot showing all of the EEMs
    together

    ![](eemanalyzeR-example/summary_plots_eemanalyzeR-example.png){width="1000"}
