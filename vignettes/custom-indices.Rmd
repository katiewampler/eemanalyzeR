...
```{r}
indices <- get_indices(example_processed_eems, example_processed_abs, index_method = zhang2025, return = "wide", mdl_dir = file.path(system.file("extdata", package = "eemanalyzeR")))
