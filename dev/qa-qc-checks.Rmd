...
[run_eems](../html/run_eems.html) functions contains a file named
`readme_*.txt` where **`*`** is the project name.

**This file contains information about:**

-   the processing steps performed including the function arguments
-   any warnings that occurred
-   information about the QA/QC checks performed
