...
#'
#' Will accept absorbance files run via Aqualog exported using the sample Q or manually.
#' If the function tries to load an EEM file, it will return a warning and a `NULL` value for absorbance.
#'
