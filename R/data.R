...
#' 2199-2209. \doi{10.1021/acsestwater.3c00017}
#'
#' Galgani, L., Engel, A., Rossi, C., Donati, A., & Loiselle, S. A. (2018). Polystyrene microplastics increase microbial release of
#' marine Chromophoric Dissolved Organic Matter in microcosm experiments. Scientific Reports, 8(1), 14635. \doi{10.1038/s41598-018-32805-4}
#'
...
#' 2018-1096). Reston, VA: U.S. Geological Survey. \doi{10.3133/ofr20181096}
#'
...
#' 955-969. \doi{10.4319/lo.2008.53.3.0955}
#'
...
#' South China Sea using EEMs-PARAFAC and absorption spectroscopy. Journal of Sea Research, 180, 102159. \doi{10.1016/j.seares.2021.102159}
#'
#' Meingast, K. M., Kane, E. S., Marcarelli, A. M., Wagenbrenner, J. W., & Beltrone, V. G. (2023). Seasonal trends of DOM character in soils
#' and stream change with snowmelt timing. Water Resources Research. 59(3): e2022WR032014. \doi{10.1029/2022WR032014}
#'
...
#' Chimica Acta, 337(2), 133-149. \doi{10.1016/S0003-2670(96)00412-6}
#'
...
#' 37(20), 4702-4708. \doi{10.1021/es030360x}
#'
#' Zalba, P., Amiotti ,Nilda M., Galantini ,Juan A., & and Pistola, S. (2016). Soil Humic and Fulvic Acids from Different Land-Use Systems
#' Evaluated By E4/E6 Ratios. Communications in Soil Science and Plant Analysis, 47(13-14), 1675-1679. \doi{10.1080/00103624.2016.1206558}
#'
#' Zsolnay, A., Baigar, E., Jimenez, M., Steinweg, B., & Saccomandi, F. (1999). Differentiating with fluorescence spectroscopy the sources of
#' dissolved organic matter in soils subjected to drying. Chemosphere, 38(1), 45-50. \doi{10.1016/S0045-6535(98)00166-0}
