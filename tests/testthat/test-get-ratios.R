test_that("correct flags are returned", {
  expect_equal(get_ratios(1,0), "DATA_03")
  expect_equal(get_ratios(1,NA), "DATA_01")

  expect_equal(get_ratios(6,3), 2)


  expect_equal(get_ratios(c(1,1,1),c(0,0,0)), rep("DATA_03",3))
  expect_equal(get_ratios(c(1,1,1),c(NA,NA,NA)), rep("DATA_01",3))
